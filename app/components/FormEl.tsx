function FormEl() {
  return (
    <div className="relative my-6  mx-auto  px-4 md:px-24">
      <div className="absolute   z-1 cursor-pointer inset-y-0 start-0 flex items-center ps-3 left-[20px] md:left-24">
        <svg
          stroke="currentColor"
          fill="currentColor"
          stroke-width="0"
          ...
          y="0px"
          viewBox="0 0 24 24"
          className="bg-[#703BF7] p-1 w-7 h-7 text-white rounded-lg "
          height="1em"
          width="1em"
